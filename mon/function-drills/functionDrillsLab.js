...
console.log(exclaimThree('expression')) 
...
//CODE HERE
let cost = 3
// const howManyFrogs = gold => Math.floor(gold/cost)
// console.log(howManyFrogs(36));
function howManyFrogs(gold) {
  let totalGold = gold/cost
   return totalGold
}
const totalFrogs = howManyFrogs(4)
...
function howManyFrogs2(gold) {
  let totalGold = Math.floor(gold/cost)
   return totalGold
}
const totalFrogs2 = howManyFrogs2(4)
...
let bathtubScope = ['sailorDuck','squeaky']

//This array should contain the variable names (as strings) accessible in the pond function.
let pondScope = ['realDuck','squeaky']