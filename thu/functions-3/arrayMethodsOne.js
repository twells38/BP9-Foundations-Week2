...
// CODE HERE
const totalOrder = orders.map(a => a.price * (1 + a.tax))
 console.log(totalOrder)


////////// PROBLEM 6 //////////

// Do not edit the code below. // array of object
...
// CODE HERE
const totalPurchase = purchases.filter(a => a.owner === 'Bob').map(x => x.price).reduce((acc, curr) => acc + curr)
